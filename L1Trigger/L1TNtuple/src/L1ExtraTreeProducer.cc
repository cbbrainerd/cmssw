...
// 
/**\class L1ExtraTreeProducer L1ExtraTreeProducer.cc L1Trigger/L1TNtuple/src/L1ExtraTreeProducer.cc
...
#include "L1Trigger/L1TNtuple/interface/L1AnalysisL1Extra.h"
