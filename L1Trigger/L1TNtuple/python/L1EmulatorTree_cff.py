...
l1EmulatorTree = L1Trigger.L1TNtuple.l1NtupleProducer_cfi.l1NtupleProducer.clone()
...
# L1Extra Tree
import L1Trigger.L1TNtuple.l1ExtraTreeProducer_cfi
l1EmulatorExtraTree = L1Trigger.L1TNtuple.l1ExtraTreeProducer_cfi.l1ExtraTreeProducer.clone()
