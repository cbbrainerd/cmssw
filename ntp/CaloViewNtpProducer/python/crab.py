...
def Data(config):
    ...
    config.Data.inputDataset = '/DoubleMuon/Run2016C-PromptReco-v2/RECO'
...
#'/DYToLL_M_1_TuneCUETP8M1_13TeV_pythia8/RunIISpring16DR80-FlatPU8to37HcalNZSRAW_withHLT_80X_mcRun2_asymptotic_v14_ext1-v1/GEN-SIM-RAW'
