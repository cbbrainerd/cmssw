...
# with command line options: -s RAW2DIGI,RECO --no_exec --mc --conditions=80X_dataRun2_HLT_v12
...
process.RECOSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('-s_RAW2DIGI_RECO.root'),
...
process.GlobalTag = GlobalTag(process.GlobalTag, '80X_dataRun2_HLT_v12', '')
