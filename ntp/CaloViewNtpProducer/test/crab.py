...
config.General.requestName = 'DoubleMuonNtuplerRun2016B-v2'
config.General.workArea='DoubleMuonNtuplerRun2016B-v2'
...
config.Data.outputDatasetTag = 'DoubleMuonNtuplerRun2016B-v2'
