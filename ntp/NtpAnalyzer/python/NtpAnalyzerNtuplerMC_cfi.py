...
process.output=cms.OutputModule("PoolOutputModule",fileName=cms.untracked.string("file:NtpAnalysisDataNtuple.root"),SelectEvents=cms.untracked.PSet(SelectEvents=cms.vstring('p')),outputCommands=cms.untracked.vstring('keep *_*_*_NtpAnalyzerMC'),dropMetaData=cms.untracked.string('ALL'))
