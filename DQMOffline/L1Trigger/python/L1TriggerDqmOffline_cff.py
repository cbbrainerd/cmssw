...
from DQM.L1TMonitorClient.L1TStage2MonitorClient_cff import * #Defines l1TStage2Clients & l1tStage2MonitorClient 

#Upgrade emulator configuration 
...
#Following commented code is for stage1 trigger. Probably will need to do a similar thing for stage 2? Or was this hacky in the first place?
...
l1TriggerOnline = cms.Sequence(l1tStage2OnlineDQM
...
#                                * l1tSync_Offline #Ditto last comment
